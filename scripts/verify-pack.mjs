...
try {
	...
	await writeFile(
		...
		[
			...
			"const expectedStudioKeys = ['ImageAttachmentControl'];",
			'',
	...
	await writeFile(
		...
		[
			...
			"import type { ImageAttachmentControlLabels, ImageAttachmentCurrentImage, ImageAttachmentFileValidator, ImageAttachmentIntent, ImageAttachmentState, ImageAttachmentValidationError } from 'giadaware-ui-components/studio';",
			'',
	...
	await writeFile(
		...
		[
			...
			"import { ImageAttachmentControl } from 'giadaware-ui-components/studio';",
			"import type { ImageAttachmentControlLabels, ImageAttachmentIntent, ImageAttachmentState } from 'giadaware-ui-components/studio';",
			"import type { ComponentProps } from 'svelte';",
			"import 'giadaware-ui-components/visitor';",
			'',
