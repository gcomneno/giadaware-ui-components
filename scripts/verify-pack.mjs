...
try {
	...
	await writeFile(
		...
		[
			...
			'}',
			'',
			"const expectedRootKeys = ['FormStatus', 'SOCIAL_ICON_IDS', 'SocialIcon', 'SocialLink'].sort();",
			"const expectedStudioKeys = ['AsyncOperationPanel', 'Button', 'EditableList', 'EditableListRow', 'FieldDescription', 'FieldError', 'FieldLabel', 'FormActions', 'IconButton', 'ImageAttachmentControl', 'PageIntro', 'Panel', 'ReorderActions', 'Surface'].sort();",
			'',
	...
	await writeFile(
		...
		[
			...
			"import { AsyncOperationPanel, Button, EditableList, EditableListRow, FieldDescription, FieldError, FieldLabel, FormActions, IconButton, ImageAttachmentControl, PageIntro, Panel, ReorderActions, Surface } from 'giadaware-ui-components/studio';",
			"import type { AsyncOperationPanelProps, AsyncOperationState, ButtonProps, ButtonSize, ButtonVariant, EditableListProps, EditableListRowProps, FieldDescriptionProps, FieldErrorProps, FieldLabelProps, FormActionsAlign, FormActionsProps, IconButtonProps, ImageAttachmentControlLabels, ImageAttachmentCurrentImage, ImageAttachmentDropzoneOptions, ImageAttachmentFileValidator, ImageAttachmentIntent, ImageAttachmentState, ImageAttachmentValidationError, PageIntroProps, PanelHeadingLevel, PanelProps, ReorderActionsProps, ReorderActionsSize, SurfaceProps } from 'giadaware-ui-components/studio';",
			'',
