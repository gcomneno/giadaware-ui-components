...
try {
	...
	await writeFile(
		...
		[
			...
			"const expectedStudioKeys = ['AsyncOperationPanel', 'Button', 'ImageAttachmentControl', 'PageIntro'].sort();",
			'',
	...
	await writeFile(
		...
		[
			...
			"import { AsyncOperationPanel, Button, ImageAttachmentControl, PageIntro } from 'giadaware-ui-components/studio';",
			"import type { AsyncOperationPanelProps, AsyncOperationState, ButtonProps, ButtonSize, ButtonVariant, ImageAttachmentControlLabels, ImageAttachmentCurrentImage, ImageAttachmentFileValidator, ImageAttachmentIntent, ImageAttachmentState, ImageAttachmentValidationError, PageIntroProps } from 'giadaware-ui-components/studio';",
			'',
	...
	await writeFile(
		...
		[
			...
			"import { AsyncOperationPanel, Button, ImageAttachmentControl, PageIntro } from 'giadaware-ui-components/studio';",
			"import type { AsyncOperationPanelProps, AsyncOperationState, ButtonProps, ButtonVariant, ImageAttachmentControlLabels, ImageAttachmentIntent, ImageAttachmentState, PageIntroProps } from 'giadaware-ui-components/studio';",
			"import type { ComponentProps, Snippet } from 'svelte';",
			"import 'giadaware-ui-components/visitor';",
			'',
