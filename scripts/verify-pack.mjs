...
try {
	...
	await writeFile(
		...
		[
			...
			"const expectedStudioKeys = ['AsyncOperationPanel', 'Button', 'FormActions', 'ImageAttachmentControl', 'PageIntro', 'Panel'].sort();",
			'',
	...
	await writeFile(
		...
		[
			...
			"import { AsyncOperationPanel, Button, FormActions, ImageAttachmentControl, PageIntro, Panel } from 'giadaware-ui-components/studio';",
			"import type { AsyncOperationPanelProps, AsyncOperationState, ButtonProps, ButtonSize, ButtonVariant, FormActionsAlign, FormActionsProps, ImageAttachmentControlLabels, ImageAttachmentCurrentImage, ImageAttachmentFileValidator, ImageAttachmentIntent, ImageAttachmentState, ImageAttachmentValidationError, PageIntroProps, PanelHeadingLevel, PanelProps } from 'giadaware-ui-components/studio';",
			'',
			...
			"const panelProps: PanelProps = { title: 'Settings', children: panelChildren, description: panelDescription, actions: panelActions, headingLevel: panelHeadingLevel, id: 'settings-panel', class: 'panel', style: '--giu-panel-gap: 1.5rem' };",
	...
	await writeFile(
		...
		[
			...
			"import { AsyncOperationPanel, Button, FormActions, ImageAttachmentControl, PageIntro, Panel } from 'giadaware-ui-components/studio';",
			"import type { AsyncOperationPanelProps, AsyncOperationState, ButtonProps, ButtonVariant, FormActionsAlign, FormActionsProps, ImageAttachmentControlLabels, ImageAttachmentIntent, ImageAttachmentState, PageIntroProps, PanelHeadingLevel, PanelProps } from 'giadaware-ui-components/studio';",
			"import type { ComponentProps, Snippet } from 'svelte';",
			"import 'giadaware-ui-components/visitor';",
			'',
			...
			"const panelProps: PanelProps = { title: 'Settings', children: panelChildren, headingLevel: panelHeadingLevel };",
			'const panelComponentProps: ComponentProps<typeof Panel> = panelProps;',
			'// @ts-expect-error Panel title is required.',
			"const missingPanelTitle: PanelProps = { children: panelChildren };",
			'// @ts-expect-error Panel children are required.',
