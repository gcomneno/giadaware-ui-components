...
try {
	...
	await writeFile(
		...
		[
			...
			"import type { AsyncOperationPanelProps, AsyncOperationState, ButtonProps, ButtonSize, ButtonVariant, EditableListProps, EditableListRowProps, FieldDescriptionProps, FieldErrorProps, FieldLabelProps, FormActionsAlign, FormActionsProps, IconButtonProps, ImageAttachmentControlLabels, ImageAttachmentCurrentImage, ImageAttachmentDropzoneOptions, ImageAttachmentFileValidator, ImageAttachmentIntent, ImageAttachmentState, ImageAttachmentValidationError, PageIntroProps, PanelHeadingLevel, PanelProps, ReorderActionsProps, ReorderActionsSize, ReorderAnnouncementKey, ReorderAnnouncementProps, SurfaceProps } from 'giadaware-ui-components/studio';",
			'',
