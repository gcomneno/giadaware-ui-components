...
try {
	...
	await writeFile(
		...
		[
			...
			"const expectedStudioKeys = ['AsyncOperationPanel', 'Button', 'FormActions', 'ImageAttachmentControl', 'PageIntro', 'Panel', 'Surface'].sort();",
			'',
	...
	await writeFile(
		...
		[
			...
			"import { AsyncOperationPanel, Button, FormActions, ImageAttachmentControl, PageIntro, Panel, Surface } from 'giadaware-ui-components/studio';",
	...
	await writeFile(
		...
		[
			...
			"import { AsyncOperationPanel, Button, FormActions, ImageAttachmentControl, PageIntro, Panel, Surface } from 'giadaware-ui-components/studio';",
			"import type { AsyncOperationPanelProps, AsyncOperationState, ButtonProps, ButtonVariant, FormActionsAlign, FormActionsProps, ImageAttachmentControlLabels, ImageAttachmentIntent, ImageAttachmentState, PageIntroProps, PanelHeadingLevel, PanelProps, SurfaceProps } from 'giadaware-ui-components/studio';",
			"import type { ComponentProps, Snippet } from 'svelte';",
			"import 'giadaware-ui-components/visitor';",
			'',
