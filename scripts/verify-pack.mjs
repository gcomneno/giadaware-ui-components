...
try {
	...
	await writeFile(
		...
		[
			...
			"const expectedStudioKeys = ['AsyncOperationPanel', 'ImageAttachmentControl'].sort();",
			'',
	...
	await writeFile(
		...
		[
			...
			"import { AsyncOperationPanel, ImageAttachmentControl } from 'giadaware-ui-components/studio';",
			"import type { AsyncOperationPanelProps, AsyncOperationState, ImageAttachmentControlLabels, ImageAttachmentCurrentImage, ImageAttachmentFileValidator, ImageAttachmentIntent, ImageAttachmentState, ImageAttachmentValidationError } from 'giadaware-ui-components/studio';",
			'',
	...
	await writeFile(
		...
		[
			...
			"import { AsyncOperationPanel, ImageAttachmentControl } from 'giadaware-ui-components/studio';",
			"import type { AsyncOperationPanelProps, AsyncOperationState, ImageAttachmentControlLabels, ImageAttachmentIntent, ImageAttachmentState } from 'giadaware-ui-components/studio';",
			"import type { ComponentProps, Snippet } from 'svelte';",
			"import 'giadaware-ui-components/visitor';",
			'',
